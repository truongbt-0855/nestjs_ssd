...
- [ ] T004 Setup Prisma schema + PostgreSQL migrations framework
- [ ] T005 [P] Establish NestJS module boundaries for all initial domains
- [ ] T006 [P] Setup API routing, DTO validation pipeline, and strict TS checks
- [ ] T007 Create base models/entities and Prisma repositories all stories depend on
- [ ] T008 Configure global ExceptionFilter and standardized error response mapping
- [ ] T009 Setup environment configuration management
- [ ] T010 [P] Define Prisma Interactive Transaction helper/pattern for monetary flows
...
- [ ] T017 [US1] Add DTO validation and Promise<T> return typing
- [ ] T018 [US1] Ensure errors are propagated via ExceptionFilter (no ad-hoc controller try-catch)
...
- [ ] T026 [US2] If payment-related, wrap writes in Prisma Interactive Transaction
...
- [ ] T032 [US3] Verify DTO coverage + Promise<T> signature completeness
